 ...
 * This is a stripped-down version of the Canvas class from the BlueJ team, retaining only the most
...
public class SimpleCanvas {
    ...
    /**
     * Creates and displays a SimpleCanvas of size 400x400 with the default title "SimpleCanvas" and
    ...
    /**
     * Draws a rectangle on this SimpleCanvas with sides parallel to the axes between x1,y1 and
     * x2,y2 with colour c.
     */
    ...
    public void drawPic(ImageIcon imageIcon, int x, int y, int width, int height) {
        graphic.drawImage(imageIcon.getImage(), x, y, width, height, null);
        canvas.repaint();
    }
    ...
    /**
     * If this SimpleCanvas does not automatically repaint after each drawing command, this method
     * can be used to cause a manual repaint.
     */
    public void repaint() {
        canvas.repaint();
    }
    ...
    /**
     * Causes execution to pause for the specified amount of time. This is usually used to produce
     * animations in an easy manner, by repeatedly drawing, pausing, and then redrawing an object.
     */
    ...
    class CanvasPane extends JPanel {
        ...
        public void paint(Graphics g) {
            System.out.println("repaint让paint执行啦");
